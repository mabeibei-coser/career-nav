...
export const MOCK_POSITIONING: Positioning = {
  primary: {
    ...
    coreCompetencies: [
      { name: "客户沟通话术", score: 78 },
      { name: "业务流程熟练", score: 82 },
      { name: "情绪稳定度", score: 80 },
      { name: "投诉化解能力", score: 65 },
      { name: "合规话术意识", score: 70 },
    ],
    fitReason:
      "你的执行力和情绪稳定度恰好契合金融客服岗「高频操作 + 情绪稳定」的双重要求，量表也显示沟通基础不错，入门后能较快建立服务节奏。短板是「投诉化解能力」——简历和访谈中暂未看到处理冲突场景的经验，这块需要在岗前补一补。",
    specialNote:
      "针对「投诉化解能力」这项短板，建议入职前看 2-3 集银行/保险一线投诉处理纪录片或培训视频，学习「先共情后澄清」的话术结构；金融客服还需要熟悉基础金融术语和合规话术，可同步用 1-2 周研读目标机构官网的 3-5 个高频产品页，练习用通俗语言解释给陌生人听。",
  },
  secondary: {
    position: "行政人事助理",
    matchScore: 75,
    ...
    coreCompetencies: [
      { name: "多线事务调度", score: 80 },
      { name: "公文档案规范", score: 75 },
      { name: "跨部门协调", score: 78 },
      { name: "劳动法规基础", score: 60 },
      { name: "细致与零差错", score: 82 },
    ],
    fitReason:
      "做事有条理、不容易遗漏细节，恰好满足行政人事岗「多线任务、每件不出错」的核心要求；跨部门协调分值较高，可以顺畅对接多部门。短板是「劳动法规基础」——简历未体现法律法规相关学习或实操，而这块恰好是该岗位的差错成本敏感区。",
    specialNote:
      "针对「劳动法规基础」这项短板，建议通过 12333 免费课程或网络公开课提前补充《劳动合同法》《社保法》基础知识，面试时能说出 1-2 个合规操作要点（如试用期工资计算、解除劳动合同的程序），会显著提升 HR 对你「会不会出大问题」的信任度。",
  },
};
